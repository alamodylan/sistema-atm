...
class PurchaseOrder(db.Model):
    ...
    site_id = db.Column(db.BigInteger, db.ForeignKey("atm.sites.id"))
    warehouse_id = db.Column(db.BigInteger, db.ForeignKey("atm.warehouses.id"))
    ...
    currency_code = db.Column(db.String(10), default="CRC")
